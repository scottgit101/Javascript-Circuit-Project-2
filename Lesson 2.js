...
var playGuessingGame = function (randomNumber, userGuess) {
    // Student code start
if (randomNumber === userGuess) {console.log('Congrats! You have guessed correctly.');
      }
  else if (randomNumber === userGuess + 1 || userGuess - 1) {console.log('Super close! The random number was ' + randomNumber );
      }
  
  else if (randomNumber === userGuess + 2 || userGuess - 2) {console.log('Close, but no cigar! The random number was ' + randomNumber );
      }
